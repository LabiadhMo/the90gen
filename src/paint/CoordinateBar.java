...
public class CoordinateBar extends JToolBar 
{
    ...
    {
    	JLabel coordinatePic = new JLabel(new ImageIcon(getClass().getResource("/paint/icons/coordinates.png")));
    	...
    	JLabel sizePic = new JLabel(new ImageIcon(getClass().getResource("/paint/icons/size.png")));
    	this.add(sizePic);
